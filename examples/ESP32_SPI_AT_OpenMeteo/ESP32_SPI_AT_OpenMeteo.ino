...
void loop()
{
    ...
    if (getTheData(&weatherData)) printWeather(&weatherData);
    delay(1000 * 300);
}
...
void printWeather(struct currentWeatherData *_currentDataPtr)
{
